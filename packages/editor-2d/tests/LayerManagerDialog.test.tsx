...
describe('LayerManagerDialog', () => {
  it('renders the default layer with disabled rename + delete (I-56)', () => {
    ...
    const nameInput = container.querySelector('[data-component="layer-name-input"]') as HTMLInputElement;
    const deleteBtn = container.querySelector('[data-component="layer-delete-button"]') as HTMLButtonElement;
